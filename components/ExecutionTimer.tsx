          ...
          <div className="p-4 md:p-8 flex flex-col items-center min-h-[400px] justify-center">
             ...
             {timerState.status === 'IDLE' && (
                <div className="w-full space-y-8">
                    <div>
                        <label className="block text-center text-xs text-app-subtext uppercase font-bold mb-4">Definir Tempo de Execução</label>
                     ...
                     <div className="py-6 w-full max-w-lg mx-auto">
                        ...
                        <div className="flex gap-4">
                            ...
                            <button 
                                ...
                                className="flex-1 py-4 bg-app-gold text-black hover:bg-yellow-400 uppercase font-bold text-sm md:text-base transition-colors rounded-sm"
                            >
                                <CheckCircle className="inline-block mr-2 w-5 h-5"/> Sim
                            </button>
                        </div>
                     </div>
                 </div>
