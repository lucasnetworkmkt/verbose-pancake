...
interface RoutineListProps {
  ...
  dateStr: string;
  onDelete?: (routineId: string) => void; // New optional prop
}
        ...
        return (
          ...
          >
            ...
            <div className="flex items-center gap-2">
                {/* Delete Button - Only visible if prop provided */}
                {onDelete && (
                    <button 
                        onClick={(e) => {
                            e.stopPropagation();
                        ...
                        className="p-2 text-gray-600 hover:text-app-red transition-colors"
